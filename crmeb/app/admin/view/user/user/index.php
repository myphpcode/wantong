...
<!--                        <button class="layui-btn layui-btn-sm layui-btn-normal" type="button" data-type="set_info"><i class="fa fa-check-circle-o"></i>发送站内消息</button>-->
                    ...
                    <script type="text/html" id="barDemo">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <a href="javascript:void(0);" lay-event="employee">
                                    <i class="layui-icon layui-icon-star-fill" aria-hidden="true"></i> 成为员工</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" lay-event="fenxiao">
                                    <i class="layui-icon layui-icon-star-fill" aria-hidden="true"></i> 成为分销商</a>
                            </li>
<!--                            <li>-->
<!--                                <a href="javascript:void(0);" lay-event="admin_employee">-->
<!--                                    <i class="layui-icon layui-icon-star-fill" aria-hidden="true"></i> 开通员工后台</a>-->
<!--                            </li>-->
                            <li>
    ...
    layList.tool(function (event,data,obj) {
        ...
        switch (layEvent){
            ...
            case 'give_level':
                ...
                break;
            case 'employee':
                $eb.createModalFrame(data.nickname+'-成为员工',layList.Url({a:'employee',p:{uid:data.uid}}));
                break;
            case 'fenxiao':
                $eb.createModalFrame(data.nickname+'-成为分销商',layList.Url({a:'fenxiao',p:{uid:data.uid}}));
                break;
            // case 'admin_employee':
            //     $eb.createModalFrame(data.nickname+'-开通员工后台',layList.Url({a:'admin_employee',p:{uid:data.uid}}));
            //     break;
            case 'money':
